...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos.EyeTracking.Logging
{
    public abstract class BasicInputLogger : MonoBehaviour
    {
        ...
        [SerializeField]
        protected string sessionDescr = "0";

        public string LogDirectory => Path.Combine("PROGRESS_DATA", UserName);
        ...
        private string Filename
        {
            get
            {
                if (addTimestampToLogfileName)
                    return FilenameWithTimestamp + ".csv";
                else
                    return FilenameNoTimestamp + ".csv";
            }
        }

        protected string FilenameWithTimestamp
        {
            get { return (FilenameNoTimestamp + "_" + FormattedTimeStamp); }
        }
